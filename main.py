...
def main():
    ...
    if args.command == 'input':
        ...
        if args.reddit_releases_url:
            for new_book in find_books_from_table_in_reddit_releases_post(args.reddit_releases_url):
                ...
                for book in books.values():
                    ...
                    for author in authors:
                        if author.strip().lower() not in book.author.lower():
                            authors_match = False
                            break
                    if authors_match and new_book.title.lower() in book.title.lower():
